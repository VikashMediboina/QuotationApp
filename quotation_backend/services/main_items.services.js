...
pool.query("SELECT main_item_id from main_item ORDER BY main_item_id DESC LIMIT 1").then((results) => {
    ...
    pool.query(`Insert into main_item ("main_item_id", "main_item_title","main_item_desc","room_type","unit_price","inserted_by","inserted_date","tax_type","main_item_depth")  
        VALUES ($1, $2,$3,$4,$5,$6,$7,$8,$9)`,
        [new_main_item_id, body.main_item_title, body.main_item_desc,body.room_type,body.unit_price, body.inserted_by, body.inserted_date,body.tax_type,body.main_item_depth],
    ).then((val) => {
...
const get_all_main_items=()=> new Promise((resolve,reject)=>{
    ...
    const update_main_item_service = (body) => new Promise((resolve, reject) => {
        ...
        return pool.query(`UPDATE main_item SET "main_item_title"=$1 , "main_item_desc"=$2,"room_type"=$3,"unit_price"=$4,"updated_by"=$5,"updated_date"=$6,"tax_type"=$7,"main_item_depth"=$8 WHERE "main_item_id" = $9`,
        [ body.main_item_title, body.main_item_desc,body.room_type,body.unit_price, body.updated_by, body.updated_date,body.tax_type,body.main_item_depth,body.main_item_id],
        )
        .then((results) => {
            console.log(results)
