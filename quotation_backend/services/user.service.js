...
const create_user_service = (body) => new Promise((resolve, reject) => {
        create_employee_service(body).then((emp)=>{
            ...
            var new_emp_id;
                ...
                pool.query(`Insert into login ("login_id", "employee_id","email","password","inserted_by","inserted_date")  
            VALUES ($1, $2,$3,crypt($4, gen_salt('bf')),$5,$6)`,
                    [new_login_id, new_emp_id, body.employee_email, body.password, body.inserted_by, body.inserted_date],
                ).then((val) => {
    ...
    module.exports = { create_user_service,login_user_service ,update_password_service}